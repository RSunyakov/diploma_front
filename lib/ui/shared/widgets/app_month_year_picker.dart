...
const Widget _startSelectionOverlay = SizedBox();
// const Widget _endSelectionOverlay =
//     CupertinoPickerDefaultSelectionOverlay(capStartEdge: false);
const Widget _endSelectionOverlay = SizedBox();
// const Widget _mediumSelectionOverlay =
//     CupertinoPickerDefaultSelectionOverlay(
//         capEndEdge: false, capStartEdge: false);
const Widget _mediumSelectionOverlay = SizedBox();

TextStyle _themeTextStyle(BuildContext context, {bool isValid = true}) {
  return AppStyles.text18.copyWith(fontWeight: FontWeight.w400);
  // TextStyle style =
...
const Widget _leftSelectionOverlay = SizedBox();
const Widget _centerSelectionOverlay = SizedBox();
const Widget _rightSelectionOverlay = SizedBox();
  ...
  State<StatefulWidget> createState() {
    ...
    switch (mode) {
      ...
      case CupertinoDatePickerMode.monthAndYear:
        return _CupertinoDatePickerMonthAndYearState();
    }
  }
  ...
  static double _getColumnWidth(
    ...
    switch (columnType) {
      ...
      case _PickerColumnType.month:
        for (int i = 1; i <= 12; i++) {
          // FIXME(vvk):  Так себе решение, но работает
          // https://stackoverflow.com/questions/64122220/trying-to-get-months-name-from-loop-index
          final month = DateFormat.MMMM(Get.locale!.toLanguageTag()).format(
        ...
        longestText += ' '; //FIXME(Iosif): Последствия плохого решения
        break;
...
class _CupertinoDatePickerDateTimeState extends State<CupertinoDatePicker> {
  ...
  void didChangeDependencies() {
    ...
    textDirectionFactor =
        Directionality.of(context) == w.TextDirection.ltr ? 1 : -1;
...
//    assert(newDate != null);
  ...
  Widget build(BuildContext context) {
    ...
    final List<_ColumnBuilder> pickerBuilders =
        Directionality.of(context) == w.TextDirection.rtl
    ...
    return NotificationListener<ScrollNotification>(
      ...
      child: CupertinoPicker(
        ...
        children: List<Widget>.generate(12, (int index) {
          ...
          final m2 = DateFormat.MMMM(Get.locale!.toLanguageTag()).format(
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < columnWidths.length; i++) {
      ...
      if (i == 0) {
        ...
        selectionOverlay = _mediumSelectionOverlay;
      }
...
class _CupertinoTimerPickerState extends State<CupertinoTimerPicker> {
  late w.TextDirection textDirection;
  late CupertinoLocalizations localizations;
  int get textDirectionFactor {
    switch (textDirection) {
      case w.TextDirection.ltr:
        return 1;
      case w.TextDirection.rtl:
        return -1;
    }
  }
